 ...
 * states.js
 * ---------
 * All Indian states and UTs with their GST state codes.
 * Used in client form dropdowns and for IGST vs CGST+SGST logic.
 *
 * GST TYPE LOGIC:
 *   - Same state (supplier state == buyer state) → CGST + SGST
